...
## Fase Planeacion
  ...
  * [ ] **Actividades de proyecto 4**
    ...
    * [x] Diagrama de despliegue para caso de estudio y proyecto de software
...
* [ ] **Actividades de proyecto 6**
    ...
    * [x] Fundamentos en la implementación de componentes front-end, HTML, CSS, JS
...
* [ ] **Actividades de proyecto 7**
    ...
    * [x] API
    * [x] Diseño y Desarrollo de servicios web – proyecto
    * [x] API del Proyecto
